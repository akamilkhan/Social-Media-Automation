...
def banner():
    ...
    print(
        '\033[1;77m     / ___|  ___| |__   ___  __| |\033[1;92m_ __ ___   ___  \033[0m')
    print(
        '\033[1;77m     \___ \ / __| \'_ \ / _ \/ _` |\033[1;92m \'_ ` _ \ / _ \ \033[0m')
    print(
        '\033[1;77m      ___) | (__| | | |  __/ (_| |\033[1;92m | | | | |  __/ \033[0m')
    print(
        '\033[1;77m     |____/ \___|_| |_|\___|\__,_|\033[1;92m_| |_| |_|\___|\033[0mv1.0 ')
...
def login(username, password):
    ...
    sig = hmac.new(ig_sig.encode('utf-8'), data.encode('utf-8'),
                   hashlib.sha256).hexdigest()
    payload = 'signed_body=%s.%s&ig_sig_key_version=4' % (sig, data)
    resp = session.post(ENDPOINT_URL + '/accounts/login/',
...
def configure_photo(media_id, caption):
    ...
    resp = session.post(ENDPOINT_URL + '/media/configure/',
                        payload, headers=HEADERS)
    resp_json = resp.json()
...
def adjust_image(pathFile):
    ...
    new_object.save("optimized.jpg", "JPEG", quality=100,
...
def config_data(accounts_list):
    for x, e in enumerate(accounts_list):
        ...
        with open('FILENAME.csv', newline='') as csvfile:
            ...
            #date = "%02d" % (current_time.day))+'/'+str("%02d" % (current_time.month))+'/'+str(current_time.year)
            for row in csvreader:
                path_images="./output/"+str(img-1)+".jpg"
                path_img_list.append([e, path_images])
                caption="\""+row[2]+"\" - "+row[1]+"\n"
                date_list=str("%02d" % (current_time.day))+'/'+str("%02d" % (current_time.month))+'/'+str(current_time.year)
                date_hour_list=str("%02d" % (current_time.hour))+':'+str("%02d" % (current_time.minute))
                datetime_list.append([e, date_list, date_hour_list, path_images, caption])
                print([e, date_list, date_hour_list, path_images, caption])
                current_time=current_time + timedelta(minutes=120)
                img = img+1

        # while True:
        #     path_images = input(
        #         '\033[1;77m[\033[0m\033[1;31m+\033[0m\033[1;77m]\033[0m\033[1;93m Account\033[0m\033[1;77m %s\033[0m\033[1;93m, Image\033[0m\033[1;77m %d\033[0m\033[1;93m Path\033[0m\033[1;77m (Only JPG)\033[0m\033[1;93m: \033[0m' % (accounts_list[x], img))
        #     path_img_list.append([e, path_images])
        #     caption = input(
        #         '\033[1;77m[\033[0m\033[1;31m+\033[0m\033[1;77m]\033[0m\033[1;93m Account\033[0m\033[1;77m %s\033[0m\033[1;93m, Image\033[0m\033[1;77m %d\033[0m\033[1;93m Caption: \033[0m' % (accounts_list[x], img))
        #     date_list = input(
        #         '\033[1;77m[\033[0m\033[1;31m+\033[0m\033[1;77m]\033[0m\033[1;93m Account\033[0m\033[1;77m %s\033[0m\033[1;93m, Image\033[0m\033[1;77m %d\033[0m\033[1;93m Date\033[0m\033[1;77m (DD/MM/YYYY): \033[0m' % (accounts_list[x], img))
        #     date_hour_list = input(
        #         '\033[1;77m[\033[0m\033[1;31m+\033[0m\033[1;77m]\033[0m\033[1;93m Account\033[0m\033[1;77m %s\033[0m\033[1;93m, Image\033[0m\033[1;77m %d\033[0m\033[1;93m Hour\033[0m\033[1;77m (HH:MM): \033[0m' % (accounts_list[x], img))
        #     datetime_list.append(
        #         [e, date_list, date_hour_list, path_images, caption])
        #     img = img+1
...
def check_time():
    ...
    while True:
            ...
            if str("%02d" % (current_time.day))+'/'+str("%02d" % (current_time.month))+'/'+str(current_time.year) in w:
                ...
                for a, b in enumerate(datetime_list[z]):
                    ...
                    if str("%02d" % (current_time.hour))+':'+str("%02d" % (current_time.minute)) in b:
                        ...
                        print('\033[1;77m[\033[0m\033[1;31m+\033[0m\033[1;77m]\033[0m\033[1;93m Account:\033[0m\033[1;77m{}\033[0m\033[1;93m date:\033[0m\033[1;77m{}\033[0m\033[1;93m time:\033[0m\033[1;77m{}\033[0m'.format(
                            datetime_list[z][0], datetime_list[z][1], datetime_list[z][2]))

                        for c, d in enumerate(accounts_list):
                            if d == datetime_list[z][0]:
                                print(
                                    '\033[1;77m[\033[0m\033[1;31m+\033[0m\033[1;77m]\033[0m\033[1;93m Preparing post for account\033[0m\033[1;77m {0}\033[0m\033[1;93m, image\033[0m\033[1;77m {1}\033[0m'.format(d, datetime_list[z][3]))
                                login_success = False
                                tries = 0
                                while login_success != True or tries > 50:
                                    try:
        ...
        if len(datetime_list) == 0:
            print(
                '\033[1;77m[\033[0m\033[1;31m+\033[0m\033[1;77m]\033[0m\033[1;93m No remaining posts, exiting\033[0m')
            break
        time.sleep(5)
        current_time=None
